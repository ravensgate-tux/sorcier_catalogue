...
ピート・キャロルが最新刊『EPOCH』で語った「これからのケイオスマジックの時代」──それが**パンデモン期（PANDAEMON AEON）**である。

この時代には、**ゴードン・ホワイトの「アニミズム」**、**ジュリアン・ヴェインの「ネオペイガニズム」**、そして**フィル・ハインの「シャーマニズム」**といった多様な流派が、奇しくも共鳴する傾向を示している。
