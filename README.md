...
#### 2. **象徴とプログラム**  
彼は象徴（シジル、シンボル）を「プログラム」として捉え、魔術とは信念体系（operating system）を切り替える作業に近いと述べている。たとえば、サンドボックスゲーム「マインクラフト」のように、プレイヤーが環境やルールを自在に構築・変更できる仮想空間は、この発想を直感的に理解させてくれる好例だ。こうした視点は情報技術者やゲーマーにとって既に馴染み深く、魔術的思考がより一般的な知的活動の中に先行して広まっている可能性を示している。
