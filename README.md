...
**公式なコメントは出しておらず、スタンスは不明。**  
ただし、これまでの著作・講義・ブログ等において、  
**クトゥルフ神話のような「実在しないフィクション神格」への召喚や信仰行為は一切行っていない。**  
一貫して、**現実に根ざした神格（特にヘカテ）との関係性と実践的魔術**に重きを置いており、  
**成果と応用性を優先する魔術思想**が際立っている。
