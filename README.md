...
📘『**Financial Sorcery**』『**Protection & Reversal Magick**』の著者として知られ、  
現代における魔術の実用性と持続可能性を追求。  
西洋魔術に加え、**チベット密教**・**ニューオーリンズ・ヴードゥー**・**神経言語プログラミング（NLP）**・**ヘカテ女神の神殿奉仕**など、多分野にわたる実践経験を背景に、  
**「戦略的かつ持続可能な魔術」**を標榜するプログラム *Strategic Sorcery（TSS）* を主宰。
