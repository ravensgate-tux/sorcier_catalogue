...
『Liber Null』『Psychonaut』の著者であり、**ケイオスマジックの理論的創始者**。信念をツールとして扱い、必要に応じて信仰や儀式を使い分ける「**可塑的信念モデル**」を提唱。魔術の実践と結果を重視する傾向を持つ。
...
- 🚧 [『生命の焦点(1921年)』翻訳Zine（**製作中🚧**）](https://github.com/ravensgate-tux/focus-of-life/blob/main/README.md_404)
...
- **注釈付き**：上下に Spare 自筆の**意味説明（正位置・逆位置）**が記載されている。
