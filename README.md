...
『The Invisibles』の作者として**バンジージャンプ中にシジルをチャージする魔術体験**を告白し、以降のキャリアと魔術観の核心を築く。著書『POP MAGIC!』ではガネーシャ神を**魔術実践の“導きの神”**として重視し、西洋儀式魔術におけるヘルメスに対応する存在とした。
...
🧾 **今回の騒動における動向：**  
2025年、アラン・ムーアが『Bumper Book of Magic』でカオスマジックを「軽薄で疑似科学的」と批判したことを受け、キャロルは自身のブログで反論。形式主義的な魔術に対して懐疑的な立場を取りつつ、グラント・モリスン寄りの柔軟な魔術観を擁護し、クトゥルー神話の神格を含む多様な象徴体系の使用も肯定している。混沌を現代科学の未解明領域と重ねる姿勢が特徴的。。
...
🧾 **今回の騒動におけるスタンス：**  
直接的なコメントは避けているが、**クトゥルフ神話のような「フィクションを神格化する魔術」には距離を置く姿勢**を取っている。**人間と霊的存在の関係を見直し、実在的で生きた霊性を重視**する立場から、現代の魔術界に一定の批判的再編を促している。
