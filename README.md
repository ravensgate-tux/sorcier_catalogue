...
#### 1. **現実の解体と魔術の接続**  
Snellは、仮想現実の出現によって「唯一の現実」という概念が崩れつつあることを指摘する。これはケイオスマジックにおける「信念の柔軟な操作」という技法とパラレルであり、現実そのものが再構築可能なものとして理解される時代が来ていると述べている。

#### 2. **象徴とプログラム**  
彼は象徴（シジル、シンボル）を「プログラム」として捉え、魔術とは信念体系（operating system）を切り替える作業に近いと述べている。この見方は、情報技術者やゲーマーにとって極めて直感的であり、魔術がより一般的な知的活動と結びつく可能性を示している。

#### 3. **ケイオスマジックと情報時代**  
Snellは、混沌（Chaos）を「無秩序」ではなく「未決定性」として扱い、それゆえ魔術における意図的な秩序づけと親和性が高いとしている。情報時代の流動的なアイデンティティや多世界的現実は、ケイオスマジックの実践にとって新しい道を開いているという示唆がある。
